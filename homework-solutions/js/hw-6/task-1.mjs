...
const myArr3 = [3, 11, 32, 7, 20];
const [first, second, ...rest] = myArr3;
...
const arrForConcat1 = [1, 2, 3, 4, 5];
const arrForConcat2 = [6, 7, 8, 9, 10];
const mergedArray = [...arrForConcat1, ...arrForConcat2];
